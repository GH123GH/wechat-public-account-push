...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxb9a44286325376af',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'cbc65c875a5e0ed3a9082156fb174b88',
  ...
  USERS: [
    {
      ...
      id: 'occwm6lYS21Op8ZFhMSCcGyBLeu0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'u859xOh6k14hZufQeRF8ZStlqQk6Jz7vJ_rOqA-QDS4',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '菏泽',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2000-07-15' },
        // 退伍日
  ...
  CALLBACK_TEMPLATE_ID: 'u859xOh6k14hZufQeRF8ZStlqQk6Jz7vJ_rOqA-QDS4',
